...
Create a new file named \`.windsurf/rules.md\` at the root of your project. This file will define the rules that guide Windsurf's AI assistant to align with your documentation standards and workflow.

````markdown theme="github-light" dark-theme="github-dark"
